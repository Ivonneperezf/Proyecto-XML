...
// Funcion para colocar valores iniciales en paneles
function inicio(){
...
// Funcion para cancelar la edicion de receta
...
function editarReceta(recetaNodo, cambios) {
    ...
    // No hace cambios hasta que se completen
...
// Funcion para obtener la lista de ingredienets en pantalla
...
// Funcion para obtener los pasos de pantalla
...
// Funcion para buscar la receta por ID que devuelve Nodo de XML
...
async function guardar_cambios() {
    try {
        ...
        // Obtener el id de la receta desde el input
        ...
        // Crear objeto con los cambios desde el formulario
        const cambios = cargar_cambios();

        // Editar la receta y validar campos obligatorios
...
// Funcion para recopilar los cambios desde pantalla
...
// Funcion para recargar XML desde el servidor
